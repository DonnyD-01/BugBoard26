...
export default function HomePageAmministratore() {
    ...
    const renderRow = (issue) => (
        <div key={issue.id} className="issue-row" onClick={() => navigate(`/admin/dettaglio-issue/${issue.id}`)}>
