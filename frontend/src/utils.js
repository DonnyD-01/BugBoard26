...
export const mockIssues = [
    {
        id: 101, title: "Errore nel login con Google", type: "Bug", priority: 5, stato: "Assegnata", assignee: "Me",
    ...
    {
        id: 102, title: "Richiesta documentazione API", type: "Documentation", priority: 2, stato: "Risolta", assignee: "Luigi",
        description: "Avrei bisogno della documentazione aggiornata...",
        image: null,
        fileName: null, assigneeId: 200
    },{ id: 103, title: "Aggiungere Dark Mode", type: "Feature", priority: 3, stato: "Assegnata", assignee: "Anna" },
    { id: 104, title: "Disallineamento Navbar su Mobile", type: "Bug", priority: 4, stato: "To-do", assignee: "Me" },
    { id: 105, title: "Come resettare la password?", type: "Question", priority: 1, stato: "Risolta", assignee: "Sofia" },
    { id: 106, title: "Errore 404 su pagina profilo", type: "Bug", priority: 5, stato: "To-do", assignee: "Me" },
    { id: 107, title: "Migliorare performance dashboard", type: "Feature", priority: 3, stato: "Assegnata", assignee: "Team" },
    { id: 108, title: "Traduzione incompleta in Inglese", type: "Bug", priority: 2, stato: "To-do", assignee: "Giovanni" },
    { id: 109, title: "Aggiornare termini e condizioni", type: "Documentation", priority: 1, stato: "Risolta", assignee: "Me" },
    { id: 110, title: "Il footer si sovrappone al contenuto", type: "Bug", priority: 3, stato: "To-do", assignee: "Me" },
    { id: 111, title: "Richiesta export in PDF", type: "Feature", priority: 4, stato: "Assegnata", assignee: "Me" },
    { id: 112, title: "Login lento da Safari", type: "Bug", priority: 4, stato: "To-do", assignee: "Marco" },
];
...
export const getStatusIcon = (status, size=20) => {
    switch(status) {
        case "ToDo": return <Clock size={size}/>;
...
export const mockProjectsIssues = [
    { idIssue: 1, titolo: "Bug Login", tipo: "Bug", priorita: 5, stato: "Assegnata", EmailCr: "walter@email.com", EmailAss: "walter@email.com", IdProgetto: 1 },
    { idIssue: 2, titolo: "Nuova Grafica", tipo: "Feature", priorita: 3, stato: "Assegnata", EmailCr: "walter@email.com", EmailAss: "walter@email.com", IdProgetto: 1 },
    { idIssue: 3, titolo: "Errore API", tipo: "Bug", priorita: 4, stato: "Assegnata", EmailCr: "walter@email.com", EmailAss: "gennaro@email.com", IdProgetto: 1 },
    { idIssue: 4, titolo: "Documentazione", tipo: "Documentation", priorita: 1, stato: "ToDo", EmailCr: "walter@email.com", EmailAss: null, IdProgetto: 1 },
];